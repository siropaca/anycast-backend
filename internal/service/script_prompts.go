...
- オープニングがテーマ直球で始まっていたら、雑談から自然にテーマに入る流れに書き換える
- クロージングがまとめや教訓で終わっていたら、友達との会話が自然に終わるような余韻に書き換える
...
- 使用できる10種類をバランスよく活用する: 考えながら / 呆れて / 笑いながら / 興奮して / こっそりと / 焦って / 嬉しそうに / しみじみと / 驚いて / 真剣に
...
## 感情タグの修正
- 台本に感情タグがある場合、以下の10種類のみ使用可能:
  考えながら / 呆れて / 笑いながら / 興奮して / こっそりと / 焦って / 嬉しそうに / しみじみと / 驚いて / 真剣に
...
func getPhase3SystemPrompt(talkMode script.TalkMode, withEmotion bool, durationMinutes, episodeNumber int) string {
	...
	sb.WriteString("- オープニングはテーマにいきなり切り込まない。最近あったことや雑談から自然にテーマに流れ込むようにする\n")
	sb.WriteString("- クロージングはまとめや教訓で締めない。友達との会話が自然に終わるように、軽い雑談や次にやりたいことの話で自然に終える\n")
	...
	if withEmotion {
		...
		sb.WriteString("  考えながら / 呆れて / 笑いながら / 興奮して / こっそりと / 焦って / 嬉しそうに / しみじみと / 驚いて / 真剣に\n")
