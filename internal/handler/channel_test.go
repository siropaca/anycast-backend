...
func (m *mockChannelService) AddChannelCharacter(ctx context.Context, userID, channelID string, req request.AddChannelCharacterRequest) (*response.ChannelDataResponse, error) {
	args := m.Called(ctx, userID, channelID, req)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *mockChannelService) ReplaceChannelCharacter(ctx context.Context, userID, channelID, characterID string, req request.ReplaceChannelCharacterRequest) (*response.ChannelDataResponse, error) {
	args := m.Called(ctx, userID, channelID, characterID, req)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*response.ChannelDataResponse), args.Error(1)
...
func (m *mockChannelService) RemoveChannelCharacter(ctx context.Context, userID, channelID, characterID string) (*response.ChannelDataResponse, error) {
	args := m.Called(ctx, userID, channelID, characterID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*response.ChannelDataResponse), args.Error(1)
