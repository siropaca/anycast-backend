...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/channels/{channelId}/episodes/{episodeId}/script/generate": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "台本生成リクエスト",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.GenerateScriptRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/me/channels/{channelId}/episodes/{episodeId}/audio/generate-async": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
