...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/channels/{channelId}/episodes/{episodeId}/audio/remix-bgm": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "ボイス音声を再利用して BGM のみを差し替えた音声を再生成します。TTS をスキップするため高速です。",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "description": "ミキシングオプション",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/request.RemixBgmRequest"
                        }
                    }
                ],
                "responses": {
