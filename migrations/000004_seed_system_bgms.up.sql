...
INSERT INTO audios (mime_type, path, filename, file_size, duration_ms) VALUES
	...
	('audio/mpeg', 'audios/pastel_house.mp3', 'パステルハウス.mp3', 7549747, 180000),
	('audio/mpeg', 'audios/野良猫は宇宙を目指した.mp3', '野良猫は宇宙を目指した.mp3', 1992295, 48000),
	('audio/mpeg', 'audios/feeling_like_afternoon.mp3', '昼下がり気分.mp3', 6396314, 302000);
...
INSERT INTO system_bgms (audio_id, name, sort_order) VALUES
	...
	((SELECT id FROM audios WHERE path = 'audios/pastel_house.mp3'), 'パステルハウス', 6),
	((SELECT id FROM audios WHERE path = 'audios/野良猫は宇宙を目指した.mp3'), '野良猫は宇宙を目指した', 7),
	((SELECT id FROM audios WHERE path = 'audios/feeling_like_afternoon.mp3'), '昼下がり気分', 8);
